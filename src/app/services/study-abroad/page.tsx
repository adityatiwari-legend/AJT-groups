...
export default function StudyAbroadPage() {
  ...
  const whatsappUrl = "https://wa.me/919625903005?text=Hello%20AJT%20Overseas%2C%20I%20would%20like%20to%20book%20a%20counselling%20session%20for%20Study%20Abroad";
          ...
          <div className="lg:col-span-5">
            <div className="group relative bg-white border border-borders rounded-[32px] p-4 shadow-xl overflow-hidden transform transition-all duration-300 hover:shadow-2xl">
              ...
              <div className="p-4 text-center">
                ...
                <p className="text-[11px] text-muted-custom mt-0.5">Call / WhatsApp: +91-9625903005 | recruiter@ajtoverseas.com</p>
              </div>
            </div>
          </div>
        ...
        >
          ...
          >
            ...
            <div className="pt-2 px-2 flex flex-col sm:flex-row items-center justify-between gap-3">
              <p className="text-xs text-muted-custom">Call / WhatsApp: +91-9625903005 | recruiter@ajtoverseas.com</p>
              <a
                href={whatsappUrl}
                target="_blank"
                rel="noopener noreferrer"
