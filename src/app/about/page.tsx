    ...
    <div className="bg-slate-50 min-h-screen pb-24">
      ...
      <section className="max-w-7xl mx-auto px-6 md:px-8 pt-20">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 items-center">
          ...
          <div className="lg:col-span-6 space-y-6">
            ...
            <p className="text-[16px] text-muted-custom leading-relaxed">
              We operate out of state-of-the-art office setups in Mumbai, Chennai, and New Delhi, providing high-precision vetting, mock embassy interviews, candidate profile matching, and comprehensive visa coordination.
            </p>
          </div>
      ...
      <section className="max-w-7xl mx-auto px-6 md:px-8 pt-20" id="offices">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {[
            { city: "Mumbai (HQ)", street: "Prime Business Park, Bandra West", phone: "+91 22 9999 9999", email: "mumbai@ajtoverseas.com" },
